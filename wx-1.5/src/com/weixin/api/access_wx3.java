...
/**
 * Servlet implementation class access_wx3
 */
public class access_wx3 extends HttpServlet {
			  ...
			  System.out.println(" access_wx3 的post方法,  request.getMethod(); line 88  " +  request.getMethod());
			   ...
			   BufferedReader br = new BufferedReader(new InputStreamReader((ServletInputStream)request.getInputStream()));
				...
				while((line = br.readLine())!=null){ 
				   ...
				   System.out.println("access_wx3d的Post方法直接打印：ServletInputStream流的信息是：  "+sb);
